      ...
      <div class="modal-header">
        ...
        <div class="modal-body">
          <div class="box box-primary">
            ...
            <form role="form" name="editUser" method="POST" action="UpdateSubCategory" enctype="multipart/form-data">
              <div class="box-body">
                <div class="form-group">
                  <label for="UpdateName">Category Name</label>
                  <input type="text" class="form-control" name="update_sub_category" id="update_sub_category" />
                </div>
                ...
                <input type="submit" name="editSubCategory" value="Submit" class="btn btn-primary"/>
              </div>
...
<script>
  $(document).ready(function(){
    $('#myModal').on('show.bs.modal', function(e) {
     ...
     $('#update_Id').val(Id);   
     $('#update_sub_category').val(category_name);            
