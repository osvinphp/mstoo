...
<div class="content-wrapper">
  ...
  <section class="content">
    ...
    <div class="row"><!-- /.row -->
     <?php foreach ($ReportedPosts as $key => $value) {
      ...
      <div class="col-md-6">
        ...
        <div class="box box-widget">
          ...
          <!-- /.box-header -->
          <div class="box-body">
           <div class="flow_images"> <?php   print_r(json_decode($value->images));
          ...
          <div class="Daily">
            ...
            <a class="btn btn-block btn-primary" onclick="return confirm('Are you sure?')" href="<?php echo site_url('Dashboard/delete/'.$value->id);?>">Delete</a>
            </div>
            <div class="clear"></div>
          </div>
        </div><!-- /.box-body -->
